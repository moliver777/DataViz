...
// ----- PRIVATE FUNCTIONS ----- \\
// ----------------------------- \\
DoubleDonut.prototype._init = function(options) {
	...
	this.total = 0;
	this.runner = '1';
	this.numRunners1 = parseInt(options["numRunners1"]);
	this.numRunners2 = parseInt(options["numRunners2"]);
...
DoubleDonut.prototype._teardown = function() {
  this.name = null;
	...
	this.total = null;
	this.runner = null;
	this.numRunners1 = null;
	this.numRunners2 = null;
	this.type = null;
...
DoubleDonut.prototype._build = function() {
	var self = this;
...
DoubleDonut.prototype._fullAnimate = function() {
	var self = this;
	...
	// fracture animation definition (full #1)
	...
	// shuffle animation definition (full #2)
	...
	// reunite animation definition (full #3)
...
DoubleDonut.prototype._partialAnimate = function() {
	var self = this;
	this.targetDataset = this._dataset(); // format new dataset
...
// layout
DoubleDonut.prototype._arcs = function(x,y) {
	var currentArcs = d3.layout.pie()(x);
	var newArcs = d3.layout.pie()(y);
	var i = -1;
	while (++i <= this.numRunners2) {
		arc = currentArcs[i];
...
DoubleDonut.prototype._status = function(e) {
	return {
		data: this.data,
		error: e,
